	...
	if ($active_courses && $active_courses->have_posts()):
		while ($active_courses->have_posts()):
            ...
            <div class="tutor-mycourse-wrap tutor-mycourse-<?php the_ID(); ?>">
              ...
              <a href="<?php echo get_the_permalink(); ?>" class="tutor-course-a"><img src="<?php echo esc_url($tutor_course_img); ?>" class="tutor-mycourse-thumbnail"  alt=""></a>
        ...
        echo "<div class='tutor-mycourse-wrap'><div class='tutor-mycourse-content'>".__('No hay un curso activo', 'tutor')."</div></div>";
	endif;
