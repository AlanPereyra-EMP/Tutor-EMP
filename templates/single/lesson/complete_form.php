...
if ( ! $is_completed_lesson) {
    ...
    <div class="tutor-single-lesson-segment tutor-lesson-compelte-form-wrap">
        ...
        <form method="post">
            ...
            <button type="submit" class="course-complete-button tutor-button" name="complete_lesson_btn" value="complete_lesson"><i class="tutor-icon-mark"></i><?php _e( 'Completar lección', 'tutor' ); ?></button>
        </form>
    </div>
	<?php
}
